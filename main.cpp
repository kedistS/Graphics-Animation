...
void texts()
{
    ...
    if(counter>800&& counter<1200)
        drawstring(100, 250, 0.0, "You know that you are so lazy and slow");

    if(counter>2400&& counter<2800)
        drawstring(180, 250, 0.0, "Ha ha ha");
    if(counter>3200&& counter<3600)
        drawstring(180, 250, 0.0, "Ok, done!!! ha ha");

    if(counter>1200&& counter<1600)
        drawstring(150, 165, 0.0, "My dear friend rabbit! ");
    if(counter>1600&& counter<2000)
        drawstring(140, 165, 0.0, "why are you so proud ");
        glColor3f(1.0, 1.0, 1.0);
    if(counter>2000&& counter<2400)
        drawstring(160, 150, 0.0,"of your speed");
    if(counter>2800&& counter<3200)
        drawstring(150, 165, 0.0, "Lets have a race If you want");
    ...
    glPopMatrix();
        ...
        glColor3f(0.0, 0.0, 1);
        drawstring(150, 315, 0.0, "**************************************************************************");
        glColor3f(0.0, 0.0, 1);
        drawstring(150, 300, 0.0, "* Don't lose hope in any way on yourself  and don't underestimate anybody*");
        glColor3f(0.0, 0.0, 1);
        drawstring(150, 285, 0.0, "**************************************************************************");
        glColor3f(1.0, 0, 1);
        drawstring(500, 100, 0.0, "Presented by:");
        glColor3f(1.0, 0, 1);
        drawstring(500, 80, 0.0, "Addis Ababa University");
        glColor3f(1.0, 0, 1);
        drawstring(500, 60, 0.0, "Computer Science");
        glColor3f(1.0, 0, 1);
        drawstring(500, 40, 0.0, "Section 1");
        glColor3f(1.0, 0, 1);
        drawstring(500, 20, 0.0, "Students!!!");
    }
